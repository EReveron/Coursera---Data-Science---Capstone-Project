...
#create_ngram(n=1,list_filenames,training_set= 1)
```


```{r clean_unigram, echo=TRUE, cache = TRUE}
#clean_ngram(n=1,list_filenames,training_set= 1)
```
...
#create_ngram(n=2,list_filenames,training_set= 1)
```



```{r clean_bigram, echo=TRUE, cache = TRUE}
#clean_ngram(n=2,list_filenames,training_set= 1)
```
...
#create_ngram(n=3,list_filenames,training_set= 1)
```


```{r clean_trigram,echo=TRUE, cache = TRUE}
#clean_ngram(n=3,list_filenames,training_set= 1)
```
...
#create_ngram(n=4,list_filenames,training_set= 1)
```


```{r clean_quadgram,echo=TRUE, cache = TRUE}
#clean_ngram(n=4,list_filenames,training_set= 1)
```
...
#create_dfm(n=1,list_filenames,training_set= 1)
```


```{r trim_unidfm,echo=TRUE, cache = TRUE}
#trim_dfm(n=1,list_filenames,training_set= 1,mincount=1)
```
...
#create_dfm(n=2,list_filenames,training_set= 1)
```
...
#create_dfm(n=3,list_filenames,training_set= 1)
```
...
#create_dfm(n=4,list_filenames,training_set= 1)
```
